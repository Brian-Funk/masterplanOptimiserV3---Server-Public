...
type OperatorForm = {
  ...
  supported_optional_features: string[];
...
type ControllerForm = {
  ...
  permitted_optional_features: string[];
  governance: string;
};
  ...
  const load = useCallback(async () => {
    ...
    if (operatorResponse.ok) {
      ...
      setOperator({
        ...
        supported_optional_features: value.supported_optional_features || [],
  ...
  useEffect(() => {
    ...
    apiFetch(`/api/v1/admin/controllers/${selectedController}/governance`).then(async (response) => {
      ...
      setController({
        ...
        permitted_optional_features: value.permitted_optional_features || [],
