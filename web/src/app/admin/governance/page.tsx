  ...
  return <div className="min-h-screen bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
    ...
    <main className="mx-auto max-w-6xl space-y-6 px-4 py-8">
      ...
      <Card className="space-y-4 p-5" aria-labelledby="publish-heading">
        ...
        <Guidance title="Publication is a controller act" link={{ href: "/admin?tab=privacy", label: "Open controller-key administration" }}>A signed record proves the configured publication action and content hash. It is not legal certification and does not prove physical deletion or provider conduct. When controller trust is not ready, open Deletion evidence, expand Advanced evidence archive and signing-key administration, and complete the controller-key ceremony.</Guidance>
