      ...
      <main className="mx-auto max-w-3xl space-y-5 px-4 py-5">
        {eventManager && (
          <section className="grid grid-cols-2 gap-3">
            ...
            <Link href={`/admin?tab=public-links&event=${eventId}`} className="flex min-h-12 items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 text-sm font-medium dark:border-gray-700 dark:bg-gray-800"><Share2 size={18} /> Public links</Link>
          </section>
        )}
